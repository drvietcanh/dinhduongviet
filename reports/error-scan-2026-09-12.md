...
- `npm run qa:food-data`: **PASS** — 1.000 thực phẩm; slug/tên trùng 0; alias collision 0; thiếu macro lõi 0; cross-reference Việt sai 0.
...
- 7 thực phẩm vẫn mang cờ `needsDietitianReview` (món ước tính, lạp xưởng/thịt hun khói/xúc xích và cơm gạo lứt đỏ/đen).
