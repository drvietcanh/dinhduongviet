...
5. Với hậu tố `tươi`, kiểm tra mục nền có thật sự là `raw` cùng cơ sở 100 g, giống/loại và phần ăn được hay không. Nếu cùng thực phẩm nhưng khác số liệu/nguồn, đối chiếu mã nguồn, cách tính năng lượng và carbohydrate; chọn một bộ số liệu có thể truy nguyên cho mục công khai, giữ bản nguồn khác để rà soát và ghi rõ chênh lệch. Giữ mục luộc/nấu riêng.
