...
export const articles: ArticleMeta[] = [
  ...
  {
    slug: "suy-than",
    title: "Bệnh thận mạn — Chế độ ăn cho người bệnh thận",
    description: "Kiểm soát muối, đạm, kali và phốt pho theo xét nghiệm. Nguyên tắc dinh dưỡng cho bệnh thận mạn chưa lọc máu.",
    emoji: "🫘",
    category: "disease",
    categoryName: "Dinh dưỡng & Bệnh lý",
    displayCategory: "bai-viet",
