...
export const articles: ArticleMeta[] = [
  ...
  },
  {
    ...
    title: "Hen suyễn — Ăn gì giảm viêm đường thở, giảm cơn hen",
    description: "Thực phẩm giảm viêm, tăng cường chức năng phổi cho người hen. Omega-3, vitamin C, D, magie. Thực phẩm nên tránh gây co thắt phế quản.",
    emoji: "🫁",
    category: "disease",
    categoryName: "Dinh dưỡng & Bệnh lý",
    displayCategory: "bai-viet",
    ...
    readTime: 7,
    featured: false,
    tags: ["hen suyễn", "hô hấp", "phổi", "dị ứng"],
    audience: ["người hen suyễn", "người khó thở"],
    sources: [{ name: "Global Initiative for Asthma (GINA)", url: "https://ginasthma.org" }, { name: "American Academy of Allergy Asthma & Immunology", url: "https://www.aaaai.org" }],
    keywords: ["hen suyễn", "hen phế quản", "viêm đường thở", "thực phẩm hen", "omega-3 hen"],
  },
  {
