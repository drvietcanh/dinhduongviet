...
const rows: SourceRow[] = [
  ...
  { id: "com-tuoi-vdd", slug: "com-tuoi-vdd", name: "Cốm tươi", aliases: ["com tuoi"], category: "Tinh bột", state: "processed", basis: "100g sản phẩm", edibleNote: "Cốm tươi theo mục nguồn; không áp dụng cho cốm xào, bánh cốm hoặc cốm khô.", nutrients: { energyKcal: 307, proteinG: 4.4, carbG: 68.3, fatG: 1.7 }, code: "1021", review: "Giữ riêng dạng cốm tươi với các món thêm đường, dừa hoặc đậu xanh." },
