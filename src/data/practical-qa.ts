...
const qa: Record<string, PracticalQA> = {
  ...
  "ca-phe-uong-sao-cho-loi": {
    ...
    summary: "Cà phê đen (không đường, không sữa đặc) 1-2 ly/ngày có lợi: chống oxy hóa, giảm nguy cơ tiểu đường.",
  },
  "tra-sua-goc-nhin-dinh-duong": {
    ...
    whenDoctor: "Nếu đã bị tiểu đường, tiền tiểu đường, hoặc mỡ máu — nên tránh hoàn toàn.",
  ...
  "nuoc-ep-khong-nhu-trai-cay": {
    ...
    whenDoctor: "Nếu tiểu đường hoặc tiền tiểu đường — nước ép làm tăng đường huyết nhanh hơn ăn quả.",
  ...
  "trái-cây-người-tiểu-đường": {
    canEat: "Có, người tiểu đường ăn trái cây được — chọn loại ít ngọt và kiểm soát lượng.",
    ...
    summary: "Người tiểu đường vẫn ăn trái cây: ổi, thanh long, bưởi, táo — 150-200g/bữa, 2 phần/ngày.",
  },

  "dai-thao-duong": {
    canEat: "Có, người tiểu đường VẪN ăn được cơm, bún, phở, bánh mì — nhưng cần kiểm soát lượng và chọn loại.",
  ...
  "trung-thuc-pham": {
    ...
    howMuch: "Người khỏe: 1-2 quả/ngày. Người mỡ máu/tiểu đường: 3-4 quả/tuần. Không cần bỏ lòng đỏ.",
  ...
  "com-trang-tieu-duong": {
    canEat: "Có, người tiểu đường VẪN ăn cơm trắng được. Chỉ cần giảm lượng và thay đổi cách ăn.",
