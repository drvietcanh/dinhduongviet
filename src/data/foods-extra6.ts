...
export const extraFoods6: Food[] = [
  ...
  },
  {
    ...
    sourceId: "recipe-estimate-v1", confidence: "low", note: "Ước tính MVP; cholesterol rất cao."
  },
  // ── RAU CỦ ──
  {
  ...
  },
  {
    ...
    sourceId: "recipe-estimate-v1", confidence: "low", note: "Ước tính MVP; dùng lượng rất nhỏ."
  },
  {
    ...
    sourceId: "recipe-estimate-v1", confidence: "low", note: "Ước tính MVP; dùng lượng nhỏ mỗi lần."
  },
  {
