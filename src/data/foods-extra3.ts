...
export const extraFoods3: Food[] = [
  ...
  },
  {
    ...
    sourceId: "recipe-estimate-v1", confidence: "low", note: "Giá trị tham khảo theo công thức; giàu beta-carotene."
  },
  ...
  // ── ĐỒ UỐNG ──
  {
    ...
    sourceId: "recipe-estimate-v1", confidence: "low", note: "Giá trị tham khảo theo công thức; 1 ly ~200ml đá."
  },
  {
  ...
  // ── BỔ SUNG THÊM (Phase E+) ──
  {
    ...
    sourceId: "recipe-estimate-v1", confidence: "low", note: "Giá trị tham khảo theo công thức; thay đổi theo khẩu phần và cách chế biến. Ổi rất giàu vitamin C."
  },
  {
