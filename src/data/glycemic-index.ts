...
export const glycemicIndexMappings: GlycemicIndexMapping[] = [
  ...
  },
  {
    mappingId: "banh-pho-chin",
    foodSlug: "banh-pho-chin",
    aliases: ["bánh phở chín", "banh pho chin", "phở", "pho", "rice noodle", "rice noodles"],
    foodName: "Bánh phở chín",
    gi: 40,
    giCategory: "low",
    matchQuality: "generic",
    sourceLabel: "Glycemic Index FAQ / rice vermicelli and noodle guidance",
    sourceUrl: "https://glycemicindex.com/faqs/",
    note: "Dùng GI nhóm sợi gạo chín; món phở hoàn chỉnh có nước dùng và topping sẽ khác.",
    appliesTo: "Sợi phở chín riêng phần sợi.",
    notFor: "Tô phở hoàn chỉnh hoặc sợi khô chưa nấu.",
  },
  {
    mappingId: "mien-gao",
    foodSlug: "mien-gao",
