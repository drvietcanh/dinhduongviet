...
export const glycemicIndexMappings: GlycemicIndexMapping[] = [
  ...
  },
  {
    ...
    giCategory: "high",
    matchQuality: "generic",
    sourceLabel: "Bảng GI quốc tế 2021 — nhóm gạo nếp/xôi (tham khảo)",
  ...
  },
  {
    ...
    giCategory: null,
    matchQuality: "no_gi",
    sourceLabel: "Chưa có dữ liệu GI đủ tin cậy cho đúng loại và trạng thái thực phẩm này.",
    note: "Không gán GI theo nhóm mì gạo khi chưa có nguồn phù hợp trực tiếp cho bún tươi Việt Nam.",
  ...
  },
  {
    ...
    matchQuality: "no_gi",
    sourceLabel: "Chưa có dữ liệu GI đủ tin cậy cho đúng loại và trạng thái thực phẩm này.",
    note: "Không suy GI của bánh phở từ nhóm mì gạo khi chưa có nguồn phù hợp trực tiếp.",
  ...
  },
  {
    ...
    giCategory: "medium",
    matchQuality: "generic",
    sourceLabel: "Bảng GI quốc tế — nhóm ngô ngọt (tham khảo)",
    sourceUrl: GI_SEARCH_URL,
  ...
  },
  {
    ...
    giCategory: null,
    matchQuality: "no_gi",
    sourceLabel: "Chưa có dữ liệu GI đo trực tiếp đủ tin cậy cho thực phẩm này.",
    note: "Không dùng giá trị GI nội bộ chưa truy xuất được nguồn đo.",
  ...
  },
  {
    ...
    giCategory: null,
    matchQuality: "no_gi",
    sourceLabel: "Chưa có dữ liệu GI đủ tin cậy cho đúng giống và độ chín của thực phẩm này.",
    note: "Không dùng giá trị GI nội bộ chưa truy xuất được nguồn đo.",
  ...
  },
  {
    ...
    giCategory: null,
    matchQuality: "no_gi",
    sourceLabel: "Chưa có dữ liệu GI đo trực tiếp đủ tin cậy cho đúng loại miến này.",
    note: "Không dùng giá trị GI nội bộ chưa truy xuất được nguồn đo.",
  ...
  },
  {
    ...
    giCategory: null,
    matchQuality: "no_gi",
    sourceLabel: "Chưa có dữ liệu GI đo trực tiếp đủ tin cậy cho sản phẩm này.",
    note: "Không dùng giá trị GI nội bộ chưa truy xuất được nguồn đo; lượng carbohydrate vẫn có thể tra ở công cụ tính carb.",
  ...
  },
  {
    ...
    giCategory: null,
    matchQuality: "no_gi",
    sourceLabel: "Chưa có dữ liệu GI đủ tin cậy cho đúng sản phẩm sữa và hàm lượng đường này.",
    note: "Không dùng giá trị GI nội bộ chưa truy xuất được nguồn đo.",
  ...
  },
  {
    ...
    giCategory: null,
    matchQuality: "no_gi",
    sourceLabel: "Chưa có dữ liệu GI đủ tin cậy cho đúng trạng thái chế biến này.",
    note: "Không dùng giá trị GI nội bộ chưa truy xuất được nguồn đo.",
  ...
  },
  {
    ...
    giCategory: "medium",
    matchQuality: "exact",
    sourceLabel: "University of Sydney GI Search — sucrose/đường ăn",
    sourceUrl: GI_SEARCH_URL,
